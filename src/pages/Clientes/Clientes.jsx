...
export function Clientes() {
  ...
  function pdfGenerator() {
    axios
      .get("http://localhost:3001/pdf", {
        responseType: "blob",
      })
      .then((response) => {
        const arquivo = new Blob([response.data], { type: "application/pdf" });
  ...
  return (
    <div className="clientes container">
      <div className="d-flex justify-content-between align-items-center">
        <h1>Clientes</h1>
        <Button onClick={/* () => window.open("http://localhost:3001/pdf", "_blank") */ pdfGenerator} variant="danger">
          <i class="bi bi-filetype-pdf"></i> Gerar PDF de Clientes
        </Button>
